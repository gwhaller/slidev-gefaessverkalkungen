...
<div class="grid grid-cols-2 gap-x-6 gap-y-13 mx-auto w-full max-w-4xl mt-16 px-8">
  ...
  <div class="flex items-center justify-center gap-4">
    ...
    <div
      class="w-32 h-32 rounded-full bg-green-400 flex items-center justify-center transition-opacity duration-500"
  ...
  <div class="flex items-center justify-start gap-4">
    <div
      class="w-32 h-32 rounded-full bg-yellow-400 flex items-center justify-center transition-opacity duration-500"
  ...
  <div class="no-dim flex items-center justify-center gap-4">
    <!-- Papier-Bild + Extra: ab Click 8, bleibt sichtbar -->
    <div class="relative" :style="{ visibility: $clicks >= 8 ? 'visible' : 'hidden' }">
      ...
      >Extra</span>
      <img src="/assets/images/papier.avif" class="no-dim w-24 h-24 object-cover rounded" />
    </div>
    ...
    <div class="relative" :style="{ visibility: $clicks >= 7 ? 'visible' : 'hidden' }">
      <div
        ...
        :style="{ transform: $clicks >= 16 ? 'scale(1.5)' : ($clicks >= 9 ? 'scale(0.5)' : 'scale(1)') }"
      >
  ...
  <div class="no-dim flex items-center justify-start gap-4">
    <div
      ...
      :style="{ opacity: $clicks >= 14 ? 1 : 0, visibility: $clicks >= 14 ? 'visible' : 'hidden' }"
...
<!-- Anchor: zwingt Slidev zu 16 Click-Steps -->
<span v-click="16" class="absolute opacity-0 pointer-events-none" />
